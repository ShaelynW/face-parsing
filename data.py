...
class dataProcess(object):
    def __init__(self, data_path="/home/boriska/Downloads/CamVid/train",
                 label_path="/home/boriska/Downloads/CamVid/trainannot",
                 test_path="/home/boriska/Downloads/CamVid/test",
                 val_path="/home/boriska/Downloads/CamVid/val",
                 val_label_path="/home/boriska/Downloads/CamVid/valannot",
                 npy_path=os.getcwd(),
                 img_type="png"):
...
#            img=img_to_array(load_img(self.test_path+"/"+midname))
    ...
    def create_val_data(self):
        ...
        for imgname in imgs:
            midname=imgname[imgname.rindex("/")+1:]#get image name
#            img=img_to_array(load_img(self.data_path+"/"+midname))
            img,img_h,img_w=util.get_image(self.val_path+"/"+midname) 
#            label=img_to_array(load_img(self.label_path+"/"+midname))
            label,y_h,y_w=util.get_label(self.val_label_path+"/"+midname)
            imgdatas.append(img)
            imglabels.append(label)
            if i%100 ==0:
                print('Done:{0}/{1} images'.format(i,len(imgs)))
